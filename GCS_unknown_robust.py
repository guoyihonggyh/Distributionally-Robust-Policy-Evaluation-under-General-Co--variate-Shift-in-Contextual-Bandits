...
def train(dataname,lr,batch_size):
    ...
    def train_robust_regression(logging_index, logging_action, logging_reward, \
        ...
        #     logging_policy = logging_policy[logging_index, logging_action]
        # except:
        #     for t in range(len(logging_index)):
        #         print(logging_index[t], logging_action[t])
        #         print(logging_policy.shape)
        #         print(logging_policy[logging_index[t], logging_action[t]])
                    ...
                    for _ in tqdm(range(10)):
                        ...
                        for size in size_list:
                            ...
                            res = evaluate_ips(logging_index, logging_action, logging_reward, \
                                               eval_index_logging_policy, eval_action_logging_policy, eval_reward_logging_policy, \
                                               xy, label, pdf, pdf_eval, estimated_loggign_policy, eval_policy, GT)
...
for dataname in datalist:
    for lr in lrlist:
        for batchsize in batchsize_list:
            ...
            savepath = os.path.join('tune', dataname + '_' + str(lr) + '_' + str(batchsize)) + 'onehone_xshift_v5_4unknown.csv'
